...
newaction {
    ...
    execute = function ()
        os.execute("premake5 gmake")
        os.execute("make")
        os.execute("valgrind --leak-check=full --show-leak-kinds=all -s ./" .. BUILD_DIR .. "bin/Debug/" .. CLIENT_OR_SERVER .. PROJECT_NAME)
    end
}
...
local function setup_config()
    ...
    "fetchers_commands_args": [
      "-q 1 -u 'https://api.open-meteo.com' -r '/v1/forecast?latitude=65.58&longitude=22.15&minutely_15=direct_radiation,diffuse_radiation,direct_normal_irradiance,temperature_2m,weather_code' -o %s/data/weather -n weather_SE1.json",
      "-q 1 -u 'https://api.open-meteo.com' -r '/v1/forecast?latitude=62.39&longitude=17.31&minutely_15=direct_radiation,diffuse_radiation,direct_normal_irradiance,temperature_2m,weather_code' -o %s/data/weather -n weather_SE2.json",
      "-q 1 -u 'https://api.open-meteo.com' -r '/v1/forecast?latitude=59.33&longitude=18.07&minutely_15=direct_radiation,diffuse_radiation,direct_normal_irradiance,temperature_2m,weather_code' -o %s/data/weather -n weather_SE3.json",
      "-q 1 -u 'https://api.open-meteo.com' -r '/v1/forecast?latitude=55.71&longitude=13.19&minutely_15=direct_radiation,diffuse_radiation,direct_normal_irradiance,temperature_2m,weather_code' -o %s/data/weather -n weather_SE4.json",
